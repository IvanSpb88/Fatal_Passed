...
from ui_tests.page.cart_page import CartPage
from ui_tests.page.main_page import MainPage
...
class TestUI:
    ...
    def test_buy_button(self):
        ...
        main_page.fill_search_field("Математика")
        main_page.click_on_find_button()
        main_page.scroll_down_dynamic_page()
        main_page.save_product_card_name()
    ...
    def test_card_button(self):
        ...
        main_page.scroll_down_dynamic_page()
        main_page.save_product_card_name()
        main_page.save_product_card_old_price()
        main_page.save_product_card_discount_price()
        main_page.click_on_product_buy_button()
